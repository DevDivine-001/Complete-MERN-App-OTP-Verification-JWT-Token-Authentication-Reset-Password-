      ...
      <div className="flex h-screen justify-center items-center">
        <div className={Styles.glass}>
          <div className="title flex flex-col items-center">
            <h4 className="text-5xl font-bold max-sm:text-3xl">Hello Divine</h4>
            <span className="py-4 text-xl w-2/3 text-center text-gray-500 max-sm:text-sm">
              Explore More by connecting With us.

            </span>
          </div>
          <form action="" className="py-1 gap-3 bg-[] flex flex-col">
